...
class _PlayerPotrait extends State<PlayerPotrait> {
            ...
            child: Column(
              children: <Widget>[
                ...
                Container(
                  ...
                  padding: EdgeInsets.fromLTRB(0, 10, 0, 0),
                  child: Text(
                    "\t\t\t\t\t\t正午阳光与爱奇艺达成合作,退出基于余耕(本名王兵)小说《如果没有明天》改编的超级网剧《我是余欢水》,由《都挺好》编剧王三毛、王磊父子改编,孙魔龙指导,侯洪亮制片。由《都挺好》编剧王三毛、王磊父子改编,孙魔龙指导,侯洪亮制片。由《都挺好》编剧王三毛、王磊父子改编,孙魔龙指导,侯洪亮制片。",
                    style: TextStyle(
                      fontSize: 14.0, // 文字大小
                    ),
  ...
  void _playInput() async {
    await mediaController.setDataSource(VideoDataSource.springBootMenuM3u8);
